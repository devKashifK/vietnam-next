  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative bg-content border border-black/5 shadow-md  px-8 py-6 md:w-[450px] h flex-col gap-4"
            // style={{
            //   background:
              ...
              <div className="flex gap-2 justify-start mt-6 items-center">
                ...
                <div className="relative z-20 flex flex-row items-center">
                  <span className="flex flex-col gap-0.5 text-left">
                    <span className="text-base leading-[1.6] text-background font-bold font-primary tracking-wider">
                      {item.name}
                    </span>
