...
const pageData = [
  ...
  },
  {
    ...
    content: [
      ...
      "Phù hợp 1 trong 3 chương trình của Express Entry liên bang như Chương trình Công nhân lành nghề liên bang (Federal Skilled Worker Program), Chương trình giao dịch tay nghề liên bang (Federal Skilled Trades Program), Chương trình kinh nghiệm làm việc tại Canada (Canadian Experience Class)",
